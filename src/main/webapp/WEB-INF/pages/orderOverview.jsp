...
<tags:master pageTitle="Checkout">
  ...
  <h1>Your details</h1>
  <table>
    <tags:orderOverviewRow paramName="firstName" order="${order}" label="First name"></tags:orderOverviewRow>
    <tags:orderOverviewRow paramName="lastName" order="${order}" label="Last name"></tags:orderOverviewRow>
    <tags:orderOverviewRow paramName="phone" order="${order}" label="Phone"></tags:orderOverviewRow>
    <tags:orderOverviewRow paramName="deliveryDate" order="${order}" label="Delivery date"></tags:orderOverviewRow>
    <tags:orderOverviewRow paramName="deliveryAddress" order="${order}" label="Delivery address"></tags:orderOverviewRow>
    <tr>
